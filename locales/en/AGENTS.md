...
- `adr-orchestrator` — intake, portfolio, phase execution, validation, handoff, and closeout.
- `doc-keeper` — update SSoT, register ADRs, and archive stale plans **before** a commit or when closing a milestone.
